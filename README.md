...
2. Each store can have it's own layout(s) - these layouts should be located in the app/views/spree/layouts/_store#code_/ directory. So, if you have a store with
a code of "alpha" you should store it's default layout in app/views/spree/layouts/alpha/spree_application.html.erb
...
2. Automatic defacing of store layouts (e.g. analytics deface) with matching core Deface::Override.all definitions.
